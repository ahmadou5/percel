      ...
      <View style={styles.backdrop}>
        ...
        <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
          ...
          <Text style={[styles.description, { color: palette.textSecondary }]}>
            Percel needs your location to dispatch nearby orders, calculate accurate delivery routes, and provide live GPS updates to customers.
          </Text>
          ...
          <View style={[styles.featureRow, { backgroundColor: palette.bg, borderColor: palette.border }]}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={[styles.featureTitle, { color: palette.text }]}>Precise Navigation</Text>
              <Text style={[styles.featureSubtitle, { color: palette.textSecondary }]}>
                Turn-by-turn navigation to pickup and dropoff points.
              </Text>
            </View>
          </View>
