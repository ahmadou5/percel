...
export function formatTransactionTitle(
  ...
  // 1. Wallet Top Up / Funding (e.g. "monnify wallet funding", "paystack wallet funding", "Wallet top up initialization")
  if (
    cat === 'TOP_UP' ||
  ...
  // 2. TV Subscriptions (e.g. "dstv dstv-ppadi bundle subscription", "gotv gotv-jolli")
  if (
    cat === 'TV' ||
    ...
    else if (descLower.includes('smallie')) plan = 'Smallie';
    else if (descLower.includes('max')) plan = 'Max';
    else if (descLower.includes('supa')) plan = 'Supa';
    else if (descLower.includes('basic')) plan = 'Basic';
    else if (descLower.includes('classic')) plan = 'Classic';
  ...
  // 3. Data Subscriptions (e.g. "etisalat-data dataplan", "mtn-data dataplan")
  ...
  // 4. Airtime Top Up (e.g. "MTN airtime", "etisalat airtime")
  ...
  // 5. Electricity (e.g. "ikeja electricity", "eko electricity")
  ...
  // 7. Orders / Earnings / Refunds / Commission
