...
export default function PreferencesScreen() {
  ...
  const deviceScheme = (useDeviceColorScheme() ?? 'light') as 'light' | 'dark';
  ...
  return (
    <ScrollView style={[styles.screen, { backgroundColor: palette.bg }]} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.heroCard, { backgroundColor: palette.card, borderColor: palette.border }]}> 
        ...
        <Text style={[styles.heroTitle, { color: palette.text }]}>Pick a theme that matches how you like to work.</Text>
      </View>
        ...
        <View style={styles.themeList}>
          ...
          >
            ...
            <View style={styles.themeCopy}>
              ...
              <Text style={[styles.themeSubtitle, { color: palette.textSecondary }]}>Build a palette with your own accent and background colors.</Text>
            </View>
        ...
        <View style={styles.modalBackdrop}>
          ...
          <View style={[styles.sheet, { backgroundColor: palette.card, borderColor: palette.border }]}>
            ...
            <View style={styles.sheetHeader}>
              ...
              <Text style={[styles.sheetCopy, { color: palette.textSecondary }]}>Pick an accent and background, then preview the palette before applying it.</Text>
            </View>
            ...
            <View style={styles.previewCard}>
              <View style={[styles.previewScreen, { backgroundColor: draftTheme.background }]}> 
                ...
                <View style={[styles.previewPanel, { backgroundColor: 'rgba(255,255,255,0.10)' }]}>
                  ...
                  <Text style={styles.previewTitle}>Balance • Delivery • Wallet</Text>
            ...
            <View style={styles.optionGroup}>
              ...
              <View style={styles.swatchRow}>
                {ACCENT_SWATCHES.map((color) => {
                  ...
                  return (
                    <Pressable key={color} onPress={() => setDraftTheme((current) => ({ ...current, accent: color }))} style={[styles.swatch, { backgroundColor: color, borderColor: active ? palette.text : 'transparent' }]} />
                  );
                })}
              </View>
            </View>
            ...
            <View style={styles.optionGroup}>
              ...
              <View style={styles.swatchRow}>
                {BACKGROUND_SWATCHES.map((color) => {
                  ...
                  return (
                    <Pressable key={color} onPress={() => setDraftTheme((current) => ({ ...current, background: color }))} style={[styles.swatch, { backgroundColor: color, borderColor: active ? palette.text : palette.border }]} />
                  );
                })}
              </View>
            </View>
            ...
            <View style={styles.sheetActions}>
              <Pressable onPress={() => setCustomVisible(false)} style={[styles.sheetButton, { backgroundColor: palette.bg, borderColor: palette.border }]}>
                <Text style={[styles.sheetButtonText, { color: palette.text }]}>Cancel</Text>
              </Pressable>
              <Pressable onPress={() => void applyCustomTheme()} style={[styles.sheetButton, { backgroundColor: palette.primary, borderColor: palette.primary }]}>
