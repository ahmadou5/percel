      ...
      <View style={styles.quickSection}>
        ...
        <View style={styles.quickRow}>
          {quickAmounts.map((value) => (
            <Pressable key={value} onPress={() => setAmount(String(value))} style={[styles.quickChip, { backgroundColor: amountValue === value ? palette.primary : palette.card, borderColor: amountValue === value ? palette.primary : palette.border }]}>
