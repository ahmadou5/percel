...
import { ChevronLeft, Send, User, Truck, X } from 'lucide-react-native';
import { http } from '@/lib/api';
import { useAppPalette } from '@/lib/theme';
import { Spacing } from '@/constants/spacing';
import { Typography } from '@/constants/typography';
import { subscribeToOrderChat } from '@/lib/socket';
...
export function OrderChatModal({ visible, orderId, driverName = 'Driver', onClose }: Props) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToOrderChat(orderId, (msg: ChatMessage) => {
      setMessages((prev) => {
          ...
          <View style={[styles.header, { borderBottomColor: palette.border }]}>
            <View style={styles.headerTitleRow}>
              ...
              <View>
                ...
                <Text style={[styles.driverSub, { color: palette.textSecondary }]}>Active Delivery Chat</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  driverAvatar: { width: 40, height: 40, borderRadius: 16, alignItems: 'center', justifyContent: 'center' },
  driverTitle: { fontSize: Typography.md, fontFamily: Typography.family.bold },
  driverSub: { fontSize: Typography.xs, fontFamily: Typography.family.regular },
