...
export function DriverCashoutsTable({
  ...
  const [payouts, setPayouts] = useState<AdminPayout[]>(() => {
    if (initialPayouts.length > 0) return initialPayouts;
    // Mock dataset covering pending, completed, rejected, and failed states for demo
    return [
      {
        id: 'pay-1',
        ...
        accountNumber: '5391204821',
        maskedAccountNumber: '******4821',
        accountName: 'IBRAHIM SANI',
        amount: '₦25,000',
        rawAmount: 25000,
        driverWalletBalance: '₦38,500',
        requestedAt: '2 hours ago',
        status: 'PENDING',
        riskFlags: ['First-time Payout', 'Recently Added Bank'],
      },
      {
        id: 'pay-2',
        ...
        driverId: 'd-2',
        bankName: 'Kuda Bank',
        accountNumber: '2019481029',
        maskedAccountNumber: '******1029',
        accountName: 'CHINEDU OKAFOR',
        amount: '₦68,000',
        rawAmount: 68000,
        driverWalletBalance: '₦72,000',
        requestedAt: '4 hours ago',
        status: 'PENDING',
        riskFlags: ['High Value (> ₦50k)'],
      },
      {
        id: 'pay-3',
        driverName: 'Ngozi Umeh',
        driverPhone: '+234 805 111 2233',
        driverId: 'd-3',
        bankName: 'Access Bank',
        accountNumber: '0012948102',
        maskedAccountNumber: '******8102',
        accountName: 'NGOZI UMEH',
        amount: '₦18,500',
        rawAmount: 18500,
        driverWalletBalance: '₦22,000',
        requestedAt: 'Yesterday',
        status: 'COMPLETED',
        monnifyReference: 'MNF-NIP-99120481',
        processedAt: 'Yesterday 14:32',
      },
      {
        id: 'pay-4',
        driverName: 'Aisha Bello',
        driverPhone: '+234 807 444 5566',
        driverId: 'd-4',
        bankName: 'First Bank of Nigeria',
        accountNumber: '3049102847',
        maskedAccountNumber: '******2847',
        accountName: 'AISHA BELLO',
        amount: '₦45,000',
        rawAmount: 45000,
        driverWalletBalance: '₦45,000',
        requestedAt: '2 days ago',
        status: 'FAILED',
        failureReason: 'Monnify NIP Gateway Timeout — NIBSS Interbank Offline',
      ...
      },
      {
        ...
        amount: '₦30,000',
        rawAmount: 30000,
        driverWalletBalance: '₦30,000',
        requestedAt: '3 days ago',
        status: 'REJECTED',
        rejectionReason: 'Suspicious activity / fraud flag on courier account',
